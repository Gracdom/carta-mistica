  ...
  return (
    <div className="bg-[#030312] min-h-screen">
      ...
      <main className="relative min-h-screen flex items-center justify-center px-4 py-32 overflow-hidden"
        ...
        <div className="absolute rounded-full pointer-events-none"
          style={{ width: '300px', height: '300px', background: 'radial-gradient(circle,rgba(168,85,247,.08) 0%,transparent 65%)', bottom: '0', left: '10%', animation: 'orbPulse 10s ease-in-out infinite', animationDelay: '2s' }} />
              ...
              {enviado ? (
                <div className="relative text-center py-6">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5"
                    style={{ background: 'rgba(109,40,217,.2)', border: '1px solid rgba(139,92,246,.4)' }}>
                    <CheckCircle size={28} className="text-purple-400" />
                  </div>
                  <h2 className="font-playfair text-2xl font-bold text-white mb-3">¡Cuenta creada!</h2>
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    Te enviamos un email de confirmación. Revisá tu bandeja y confirmá tu cuenta para ingresar.
                  </p>
                  <Link to="/login"
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="relative space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="Mínimo 6 caracteres" className={INPUT + ' pr-11'}
                        />
                    ...
                    <div>
                      <label className="block text-gray-300 text-xs font-semibold mb-1.5">Confirmar contraseña</label>
                      <input
                        required type={showPass ? 'text' : 'password'} name="confirm"
                        value={form.confirm} onChange={handleChange}
                        placeholder="Repetí la contraseña" className={INPUT}
                      />
                    </div>
