  ...
  return (
    <BrowserRouter>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 w-12 h-12 lg:w-14 lg:h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg shadow-green-900/40 z-50 transition-all duration-300 hover:scale-110"
      >
